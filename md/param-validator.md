...
这篇文章的重点并不是讲如何使用gin框架校验参数，不要只是觉得gin检验参数很方便，而是学习其中包含的编程思想，从而提高自己的开发水平和开发效率，DRY、分离Control、Logic、SOC后续还会继续深入学习，请大家保持耐心。

开发中经常会出现格式如`1,2,3,4,5`的参数，那么我们又要如何优雅的应对呢，请看下文分解。
