...
func (pu *PostUpdate) SetView(i int) *PostUpdate {
...
func (pu *PostUpdate) SetNillableView(i *int) *PostUpdate {
	if i != nil {
		pu.SetView(*i)
	}
	return pu
...
func (pu *PostUpdate) AddView(i int) *PostUpdate {
...
func (pu *PostUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.AddedView(); ok {
		_spec.AddField(post.FieldView, field.TypeInt, value)
	}
...
// SetView sets the "view" field.
func (puo *PostUpdateOne) SetView(i int) *PostUpdateOne {
...
// SetNillableView sets the "view" field if the given value is not nil.
func (puo *PostUpdateOne) SetNillableView(i *int) *PostUpdateOne {
	if i != nil {
		puo.SetView(*i)
	}
	return puo
...
// AddView adds i to the "view" field.
func (puo *PostUpdateOne) AddView(i int) *PostUpdateOne {
