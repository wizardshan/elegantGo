...
func (m *PostMutation) SetView(i int) {
	m.view = &i
	m.addview = nil
}

// View returns the value of the "view" field in the mutation.
func (m *PostMutation) View() (r int, exists bool) {
	v := m.view
	if v == nil {
		return
	}
...
// If the Post object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PostMutation) OldView(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PostMutation) AddView(i int) {
	if m.addview != nil {
		*m.addview += i
	} else {
		m.addview = &i
...
func (m *PostMutation) AddedView() (r int, exists bool) {
	v := m.addview
	if v == nil {
		return
	}
