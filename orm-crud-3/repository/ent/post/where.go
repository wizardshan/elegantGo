...
import (
	"elegantGo/orm-crud-3/repository/ent/predicate"
	"time"
...
func View(v int) predicate.Post {
	return predicate.Post(sql.FieldEQ(FieldView, v))
}
...
func ViewEQ(v int) predicate.Post {
	return predicate.Post(sql.FieldEQ(FieldView, v))
}

// ViewNEQ applies the NEQ predicate on the "view" field.
func ViewNEQ(v int) predicate.Post {
	return predicate.Post(sql.FieldNEQ(FieldView, v))
}

// ViewIn applies the In predicate on the "view" field.
func ViewIn(vs ...int) predicate.Post {
	return predicate.Post(sql.FieldIn(FieldView, vs...))
}

// ViewNotIn applies the NotIn predicate on the "view" field.
func ViewNotIn(vs ...int) predicate.Post {
	return predicate.Post(sql.FieldNotIn(FieldView, vs...))
}

// ViewGT applies the GT predicate on the "view" field.
func ViewGT(v int) predicate.Post {
	return predicate.Post(sql.FieldGT(FieldView, v))
}

// ViewGTE applies the GTE predicate on the "view" field.
func ViewGTE(v int) predicate.Post {
	return predicate.Post(sql.FieldGTE(FieldView, v))
}

// ViewLT applies the LT predicate on the "view" field.
func ViewLT(v int) predicate.Post {
	return predicate.Post(sql.FieldLT(FieldView, v))
}

// ViewLTE applies the LTE predicate on the "view" field.
func ViewLTE(v int) predicate.Post {
	return predicate.Post(sql.FieldLTE(FieldView, v))
}
