...
import (
	...
	"elegantGo/chapter-cache-1/repository/ent/comment"
)
...
func (repo *Comment) Fetch(ctx context.Context, id int) *domain.Comment {
	return repo.fetchOne(ctx, repo.db, func(builder *ent.CommentQuery) {
		builder.Where(comment.ID(id))
	}).Mapper()
}
func (repo *Comment) FetchOne(ctx context.Context, optionFunc func(builder *ent.CommentQuery)) *domain.Comment {
...
func (repo *Comment) FetchMany(ctx context.Context, optionFunc func(builder *ent.CommentQuery)) domain.Comments {
...
func (repo *Comment) Create(ctx context.Context, optionFunc func(builder *ent.CommentCreate)) *domain.Comment {
