...
我们在现实生活中或出去旅游爬山经常会遇到如图的台阶，又长又陡，如同天梯，让人望而生畏提心吊胆，走在这样的台阶上都会担心脚一打滑骨碌碌滚下去怎么办。

<img src="images/steps1.jpg" width="50%"> 
<img src="images/steps2.jpeg" width="50%">

也有这样的台阶可以缓解人的焦虑感，增加安全感，原理是每隔一段距离增加一个平台，把长长的台阶分成一节一节的小段，上下台阶的时候每隔一段时间可以在平台上停留休息，放松一下心情，平复心态。

<img src="images/steps3.jpeg" width="50%">

同理，当程序员阅读一个方法或函数包含几十行几百行代码的时候，如同面对又长又陡的台阶，内心是焦虑和不自信的，
...
2、修复线上bug<br>
同理，当线上出现bug，需要快速定位代码问题，第一步还是要阅读代码，在理解代码以及代码的上下游逻辑的基础上进行修复，
阅读代码时间长导致bug修复不及时，往往会降低用户体验甚至真金白银的损失，这是代码可维护性低的一种表现；

所以可读性是可扩展性、可维护性低的前置条件，决定了业务开发的进度和效率。

### 如何提高可读性？
分治法是人类解决复杂问题的一种有效策略，把大问题合理的分解为多个小问题，每个小问题都是原始问题的一个相对独立部分，
然后将这些小问题的解合并成原始问题的解。
