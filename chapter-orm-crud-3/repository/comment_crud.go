...
import (
	...
	"elegantGo/chapter-orm-crud-3/repository/ent/comment"
	"context"
)
...
func (repo *Comment) Count(ctx context.Context, optionFunc func(opt *ent.CommentQuery)) int {
	return repo.count(ctx, repo.db, optionFunc)
}

func (repo *Comment) count(ctx context.Context, db *ent.Client, optionFunc func(opt *ent.CommentQuery)) int {
	builder := db.Comment.Query()
	optionFunc(builder)
	return builder.CountX(ctx)
}

func (repo *Comment) Exist(ctx context.Context, optionFunc func(opt *ent.CommentQuery)) bool {
	return repo.exist(ctx, repo.db, optionFunc)
}

func (repo *Comment) exist(ctx context.Context, db *ent.Client, optionFunc func(opt *ent.CommentQuery)) bool {
	builder := db.Comment.Query()
	optionFunc(builder)
	return builder.ExistX(ctx)
}

func (repo *Comment) Create(ctx context.Context, optionFunc func(opt *ent.CommentCreate)) *ent.Comment {
	return repo.create(ctx, repo.db, optionFunc)
}

func (repo *Comment) create(ctx context.Context, db *ent.Client, optionFunc func(opt *ent.CommentCreate)) *ent.Comment {
	builder := db.Comment.Create()
	optionFunc(builder)
	return builder.SaveX(ctx)
}

func (repo *Comment) Update(ctx context.Context, optionFunc func(opt *ent.CommentUpdate)) int {
	return repo.update(ctx, repo.db, optionFunc)
}

func (repo *Comment) update(ctx context.Context, db *ent.Client, optionFunc func(opt *ent.CommentUpdate)) int {
	builder := db.Comment.Update()
	optionFunc(builder)
	return builder.SaveX(ctx)
}

func (repo *Comment) Delete(ctx context.Context, optionFunc func(opt *ent.CommentDelete)) int {
	return repo.delete(ctx, repo.db, optionFunc)
}

func (repo *Comment) delete(ctx context.Context, db *ent.Client, optionFunc func(opt *ent.CommentDelete)) int {
