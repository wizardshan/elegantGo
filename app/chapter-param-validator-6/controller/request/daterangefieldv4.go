...
type DateRangeFieldV4 struct {
	Start time.Time
	End   time.Time
}

func (req *DateRangeFieldV4) UnmarshalJSON(b []byte) error {
...
func (req *DateRangeFieldV4) parseElement(value string) (time.Time, error) {
	var t time.Time
	var err error
	if value == "" {
		return t, nil
...
func (req *DateRangeFieldV4) StartAble() bool {
	if req == nil {
		return false
	}
...
func (req *DateRangeFieldV4) EndAble() bool {
	if req == nil {
		return false
	}
