...
import (
	"app/chapter-param-validator-7/repository/ent/comment"
	"app/chapter-param-validator-7/repository/ent/post"
	"app/chapter-param-validator-7/repository/ent/predicate"
...
func (uu *UserUpdate) SetAmount(i int) *UserUpdate {
...
func (uu *UserUpdate) SetNillableAmount(i *int) *UserUpdate {
	if i != nil {
		uu.SetAmount(*i)
	}
	return uu
...
func (uu *UserUpdate) AddAmount(i int) *UserUpdate {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.AddedAmount(); ok {
		_spec.AddField(user.FieldAmount, field.TypeInt, value)
	}
...
// SetAmount sets the "amount" field.
func (uuo *UserUpdateOne) SetAmount(i int) *UserUpdateOne {
...
// SetNillableAmount sets the "amount" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableAmount(i *int) *UserUpdateOne {
	if i != nil {
		uuo.SetAmount(*i)
	}
	return uuo
...
// AddAmount adds i to the "amount" field.
func (uuo *UserUpdateOne) AddAmount(i int) *UserUpdateOne {
