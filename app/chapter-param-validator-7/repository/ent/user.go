...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldLevel, user.FieldAmount:
			values[i] = new(sql.NullInt64)
		case user.FieldHashID, user.FieldMobile, user.FieldPassword, user.FieldNickname, user.FieldAvatar, user.FieldBio, user.FieldStatus:
